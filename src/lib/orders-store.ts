...
const INITIAL_ORDERS: Order[] = [
  ...
  },
  {
    ...
    channel: "Mobile app",
    risk: "LOW",
    instructions: "Order cancelled by the client.",
  },
  {
    id: "ORD-5037",
    client: "Mercy Chirwa",
